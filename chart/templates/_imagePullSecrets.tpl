...
*/}}
{{- define "omar-stager.imagePullSecrets" -}}
  {{/*
  ...
  */}}
  ...
  {{- if .Values.generatedImagePullSecret -}}
    {{- if .Values.generatedImagePullSecret.create -}}
      {{- $secrets = (append $secrets (.Values.generatedImagePullSecret.name | default (include "omar-stager.fullname" .))) }}
    {{- end -}}
  {{- end -}}
...
{{- define "omar-stager.generateImagePullSecret" }}
