...
describe('yet another test', () => {
    ...
    it('Loop through and grab 3 of each mission ids', ()=> {
        allMissionIds.forEach((id) => {
            cy.request({method: "GET", url: "https://omar-dev.ossim.io/omar-wfs/wfs?filter=mission_id%20LIKE%20%27%25"+id+"%25%27&outputFormat=JSON&request=GetFeature&service=WFS&sortBy=acquisition_date%2BD&startIndex=0&typeName=omar%3Araster_entry&version=1.1.0"})
                .then((response) => {
                    let temp
